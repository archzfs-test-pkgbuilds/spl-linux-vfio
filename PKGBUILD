...
pkgrel=1
makedepends=("linux-vfio-headers=4.17.14.")
arch=("x86_64")
...
license=("GPL")
depends=("spl-utils-common=0.7.9" "kmod" "linux-vfio=4.17.14.")
prepare() {
    cd "${srcdir}/spl-0.7.9"
...
package_spl-linux-vfio-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/spl-*/4.17.14.-vfio/Module.symvers
}
